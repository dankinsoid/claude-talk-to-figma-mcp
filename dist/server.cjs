...
var shapeParams = {
  ...
  depth: import_zod.z.number().int().min(0).optional().describe("How many levels of children to expand (default 2). Deeper nodes become stubs with {childCount, more:true} \u2014 re-request that id to zoom in."),
