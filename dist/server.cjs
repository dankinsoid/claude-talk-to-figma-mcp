...
server.tool(
  ...
  {
    operation: import_zod4.z.enum(["flatten", "outline_stroke", "to_component", "detach"]).describe("Which transform to apply"),
    nodeIds: import_zod4.z.array(import_zod4.z.string()).min(1).describe("Nodes to transform. `flatten` merges all of them into one; the other ops map 1:1."),
